...
We have developed a game engine that supports big worlds. The performance if good, so it could be ported to mobile platforms (we have carefully chosen the dependencies for this purpose). We wanted to create a engine that would show to overcome the challenges of big world games and I think that that goal has been acomplished.
